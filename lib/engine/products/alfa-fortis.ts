...
export const alfaFortis: ProductDefinition = {
  ...
  calculate: (inputs: InputsDaily): ResultsDaily => {
    ...
    return calculateResultsDaily({
      ...
      managementFeeValueType: shouldUseProductDefaults ? "amount" : inputs.managementFeeValueType,
      managementFeeValue: shouldUseProductDefaults ? variantConfig.policyFeeAnnualAmount : inputs.managementFeeValue,
